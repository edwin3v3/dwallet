...
class Wallets(Base):
    ...
    sent_transactions= relationship('Transactions',back_populates = 'sender_wallet')
    received_transactions = relationship('Transactions', back_populates = 'receiver_wallet')
